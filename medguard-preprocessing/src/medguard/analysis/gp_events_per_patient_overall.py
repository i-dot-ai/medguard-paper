"""
Mean/median number of GP events per patient (overall).

Section: 2.2 Data Source and Population
Returns: patients_with_events, mean_events_per_patient, median_events_per_patient,
...
class GPEventsPerPatientOverallAnalysis(AnalysisBase):
    """GP events per patient statistics (all time)."""

    def __init__(self, processor):
        super().__init__(processor, name="gp_events_per_patient_overall")
